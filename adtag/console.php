...
if(isset($_POST['submit'])){
    ...
    $sql="INSERT INTO `adtagdata`( `developer_name`,`adtag_type`, `geo`, `campaign_name`, `master_client` ,`client`, `fcat`, `publisher`, `dims`, `status`,`status_v`) VALUES ('$dev_name','$adtag_type','$geo','$campaign_name', '$master_client' ,'$client','$fcat','$publisher','$dims','staging','staging')";
